                ...
                VStack {
                    ...
                    ScrollView(.vertical, showsIndicators: false) {
                        VStack(alignment: .leading) {
                            ...
                            HStack {
                                NavigationLink(destination: BlogArticleView(article: nextArticle, nextArticle: articles[index==articles.count-1 ? 0 : index+1], index: index==articles.count-1 ? 0 : index+1)) {
                                    HStack {
                                        VStack(spacing: 8) {
...
#Preview {
    BlogArticleView(article: articles[0], nextArticle: articles[1], index: 0)
}
